	...
	_createClass(ReactComponent, [{
		...
		value: function render() {
			...
			return React.createElement(ReactComponentRenderer, {
				...
				examples: examples.length > 0 ? React.createElement(Examples, { examples: examples, name: name, exampleMode: exampleMode }) : React.createElement(ExamplePlaceholder, { name: name }),
